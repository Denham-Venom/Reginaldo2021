...
// Garbage PID, FF, & ERRRRRRROR here 
	...
	public static final double SHOOT_LEFT_VEL_P = 0.4;
	public static final double SHOOT_RIGHT_VEL_P = 0.3;
...
// Conversions
	public static final double ADJUST_ROTS_TO_DEGR = 3. * 1260./25. / 42.; //TODO
	public static final double ADJUST_FF = 0.01;
	public static final double FEET_TO_ROT_UNITS = (2048) * (50 / 24) * (2 / Math.PI) * (5);//TODO (Ticks per rev) * (gear ratio) / (rev/ft)  c=6pi in = pi/2 ft
	public static final double RPM_TO_TP100MS = 2048./600. * 18./14.; //TODO OutRevs/Min * Min/Sec * Sec/100ms * Ticks/InRev * InRev/OutRev
	public static final double ENCODER_TICKS_TO_FEET = 1 / FEET_TO_ROT_UNITS; //TODO
//---------------------------------------------------------------------------
